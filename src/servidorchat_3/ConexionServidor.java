...
public class ConexionServidor implements ActionListener {   //Esto va 4º
    ...
    public ConexionServidor(Socket socket, JTextField tfMensaje, String usuario) {
        ...
        try {
            ...
            salidaDatos.writeUTF(usuario + ": " + tfMensaje.getText());//Aqui sale el g:
    ...
    @Override
    public void actionPerformed(ActionEvent e) {//Aqui da al boton de enviar y manda el mensaje y limpia el campo
        try {
